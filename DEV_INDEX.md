...
| 2 | **/mnt/d/Python/Balthier/wiki/WIKI_INDEX.md**
...
|---|----------|------------|
| 1 | **DEV_INDEX.md** | 📌 Хаб всех документов (этот файл) |
| 2 | **wiki/WIKI_INDEX.md** | 📋 Индекс всех вики-данных (481 файлов) |
...
| Добавить стратагему | AGENTS.md → wiki-driven | `wiki/stratagems/<faction>/<Name>.md` · или в YAML детачмента |
...
# → [10 детачментов с rule_name, stratagem_count, enhancement_count]
...
| Phase 3: AI & Automation | 🟢 29% | Greedy AI, Deployment AI (+ Faction Profiles WIP) |
