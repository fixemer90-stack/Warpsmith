...
def test_free_tier_limit(client, auth_headers):
    """Free tier: max 3 rosters."""
    client.post("/api/rosters", json={"name": "R1", ...}, headers=auth_headers)
    client.post("/api/rosters", json={"name": "R2", ...}, headers=auth_headers)
    client.post("/api/rosters", json={"name": "R3", ...}, headers=auth_headers)
    resp = client.post("/api/rosters", json={"name": "R4", ...}, headers=auth_headers)
